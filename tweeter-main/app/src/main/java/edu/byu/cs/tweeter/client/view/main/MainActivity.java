...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainActivityPresenter.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        followButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isFollowing = followButton.getText().toString().equals(v.getContext().getString(R.string.following));
                presenter.followOrUnfollow(isFollowing, selectedUser);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.logoutMenu) {
            ...
            presenter.logout();
            logOutToast.cancel(); //order change?
            return true;
        } else {
    ...
    public void onStatusPosted(String post) {
        ...
        try { //TODO try catch too?
            presenter.postStatus(post);
            postingToast.cancel(); //order change
    ...
    public void updateSelectedUserFollowingAndFollowers() {
        presenter.countFollowingAndFollowers(selectedUser);
    }
